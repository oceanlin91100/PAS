...
namespace UniPsg.Web.PAS.API
{
    public class MenuController : ApiController
    {
        ...
        // POST: api/Menu
        public HttpResponseMessage Post(MenuViewModel models)
        {
            try
            {
                service.Add(models);
        ...
        // PUT: api/Menu/5
        public HttpResponseMessage Put(MenuViewModel models)
        {
            try
            {
                service.Save(models);
        ...
        // GET: api/Menu
        [HttpGet]
        public HttpResponseMessage GetRoleMenu(string users)
        {
            try
            {
                // 取得Category資料 
                var datas = service.GetRoleMenu(users);
                return Request.CreateResponse(HttpStatusCode.OK, datas);
            }
            catch (Exception ex)
            {
